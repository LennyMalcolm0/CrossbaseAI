...
// ? TODO: Add button (similar to Google button) for sign in link
const SignUp = () => {
    const { 
        formik, 
        loading, 
        ...
        {!sentVerificationLink ? (
            <main className="text-xs pb-10">
                ...
                <p className="text-dark-200 mt-4">
                    ...
                    <span className="auth-sub-link"> Privacy Policy</span> and
                    <span className="auth-sub-link"> Terms of Service</span>
                </p>
                <div className="flex items-center gap-1.5 my-6">
                    <hr className="bg-dark-400 grow" />
                    <span className="text-dark-100 font-medium">Or</span>
                    <hr className="bg-dark-400 grow" />
                </div>
                ...
                >
                    <svg className="fill-dark-400 group-hover:fill-primary-100 transition-01" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <span className="text-dark-300 group-hover:text-primary-100 font-bold ml-4">Continue with Google</span>
                </button>
                <p className="text-dark-200 text-center mt-[15px]">
                    Already have an account?
                    <Link 
                        href={"/sign-in" + (type && storeDomain ? `?shop=${storeDomain}&type=${type}` : "")} 
