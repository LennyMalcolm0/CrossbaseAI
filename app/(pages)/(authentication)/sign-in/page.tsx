...
const SignIn = () => {
    ...
    return (  
        <main className="text-xs pb-10">
            <h1 className="text-dark-100 text-xl leading-[2] mb-5">Login</h1>
            <form onSubmit={formik.handleSubmit}>
                ...
                <p className="text-dark-200 mt-[15px]">
                    Forgot your password?
                    <Link href="/reset-password" className="auth-sub-link"> Reset Password</Link>
                </p>
                <button 
                    type="submit" 
                    disabled={loading} 
