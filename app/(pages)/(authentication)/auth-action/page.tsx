                ...
                {validActionCode ? (<>
                    {verifiedEmail ? (
                        <section>
                            ...
                            <p className="text-sm">
                                {pageActionLoading ? "Uploading your profile..." : "You'll be redirected to the app shortly..."}
                            </p>
                        </section>
                    ):(
                    ...
                    <h1 className="text-dark-100 text-xl leading-[2]">Validating Link...</h1>
                )}
            </main>
        ):(
            <div>
                <h1 className="text-dark-100 text-xl leading-[2] mb-5">Page Error</h1>
                <p className="max-sm:text-sm text-dark-300">{pageError}</p>
            </div>
        )}
    </>);
}
